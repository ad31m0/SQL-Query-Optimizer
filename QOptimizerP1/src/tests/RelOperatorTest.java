...
import iterators.relop.HashJoin;
import iterators.relop.Projection;
import iterators.relop.Selection;
   ...
   */
	protected boolean test1() {
		try {
			...
			Predicate[] preds = new Predicate[] { new Predicate(AttrOperator.LT, AttrType.FIELDNO, 3, AttrType.FLOAT, 65F), new Predicate(AttrOperator.GT, AttrType.FIELDNO, 3, AttrType.FLOAT, 15F) };
			...
			preds = new Predicate[] { new Predicate(AttrOperator.EQ, AttrType.FIELDNO, 0, AttrType.FIELDNO, 5) };
